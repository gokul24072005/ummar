  ...
  return (
    <div className="w-16 h-16 relative">
      <Canvas camera={{ position: [0, 0, 3], fov: 50 }}>
        ...
        <pointLight position={[10, 10, 10]} intensity={1} color="#8FA58C" />
  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div
          className="absolute inset-0 glass-card p-6 glow-border hover-glow backface-hidden flex flex-col"
        ...
        >
          ...
          <div className="mt-4 text-primary text-xs font-medium text-right">
            Click to flip →
          </div>
        </div>
