...
export default function AdminLogin() {
  ...
  const bgPhoto = sitePhotos?.[0]?.url ?? "";
  ...
  return (
    <div
      ...
      style={bgPhoto ? { backgroundImage: `url(${bgPhoto})`, backgroundSize: "cover", backgroundPosition: "center" } : {}}
    >
      {bgPhoto && <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" />}
      {!bgPhoto && <div className="absolute inset-0 bg-background" />}
      ...
      >
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-xl bg-primary/20 border border-primary/50 flex items-center justify-center mx-auto mb-4">
